...
--> statement-breakpoint
ALTER TABLE "likes" DROP CONSTRAINT "likes_user_id_study_id_unique";--> statement-breakpoint
ALTER TABLE "badges" DROP CONSTRAINT "badges_user_id_profiles_id_fk";
--> statement-breakpoint
ALTER TABLE "comments" DROP CONSTRAINT "comments_user_id_profiles_id_fk";
--> statement-breakpoint
ALTER TABLE "comments" DROP CONSTRAINT "comments_study_id_studies_id_fk";
--> statement-breakpoint
ALTER TABLE "likes" DROP CONSTRAINT "likes_user_id_profiles_id_fk";
--> statement-breakpoint
ALTER TABLE "likes" DROP CONSTRAINT "likes_study_id_studies_id_fk";
--> statement-breakpoint
ALTER TABLE "swipes" DROP CONSTRAINT "swipes_user_id_profiles_id_fk";
--> statement-breakpoint
ALTER TABLE "swipes" DROP CONSTRAINT "swipes_study_id_studies_id_fk";
--> statement-breakpoint
ALTER TABLE "likes" ADD CONSTRAINT "likes_user_id_study_id_pk" PRIMARY KEY("user_id","study_id");--> statement-breakpoint
...
ALTER TABLE "swipes" ADD CONSTRAINT "swipes_study_id_studies_id_fk" FOREIGN KEY ("study_id") REFERENCES "public"."studies"("id") ON DELETE cascade ON UPDATE no action;